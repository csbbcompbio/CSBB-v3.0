...
plot <- d3heatmap(data, scale = "row",color = scales::col_numeric(hmcols,c(0,1)), Rowv = TRUE, Colv=FALSE, show_grid=FALSE, theme="dark", anim_duration=0, brush_color="blue", na.rm=TRUE, cellnote_scale=TRUE, cexRow = 0.5)
png(outfile1, width = 8, height = 15, units = 'in', res = 600)
heatmap.2(data, scale = "row", col = hmcols, Rowv = TRUE, Colv=FALSE, show_grid=FALSE, na.rm = TRUE, cellnote_scale = TRUE, cexRow = 0.5, cexCol = 0.5, trace = "none", density.info = c("histogram","density","none"), labRow=FALSE)
...
plot <- d3heatmap(data, scale = "row",color = scales::col_numeric(hmcols,c(0,1)), Rowv = TRUE, Colv=FALSE, show_grid=FALSE, theme="dark", anim_duration=0, brush_color="yellow", na.rm=TRUE, cellnote_scale=TRUE, cexRow = 0.5)
png(outfile1, width = 8, height = 15, units = 'in', res = 600)
heatmap.2(data, scale = "row", col = hmcols, Rowv = TRUE, Colv=FALSE, show_grid=FALSE, na.rm = TRUE, cellnote_scale = TRUE, cexRow = 0.5, cexCol = 0.5, trace = "none", density.info = c("histogram","density","none"), labRow=FALSE)
outfile <- paste0(file, "_interactive", "_heatmap", ".html")
saveWidget(plot, outfile)
...
plot <- d3heatmap(data, scale = "row",color = scales::col_numeric(hmcols,c(0,1)), Rowv = TRUE, Colv=FALSE, show_grid=FALSE, theme="dark", anim_duration=0, brush_color="green", na.rm=TRUE, cellnote_scale=TRUE, cexRow = 0.5)
png(outfile1, width = 8, height = 15, units = 'in', res = 600)
heatmap.2(data, scale = "row", col = hmcols, Rowv = TRUE, Colv=FALSE, show_grid=FALSE, na.rm = TRUE, cellnote_scale = TRUE, cexRow = 0.5, cexCol = 0.5, trace = "none", density.info = c("histogram","density","none"), labRow=FALSE)
outfile <- paste0(file, "_interactive", "_heatmap", ".html")
saveWidget(plot, outfile)
